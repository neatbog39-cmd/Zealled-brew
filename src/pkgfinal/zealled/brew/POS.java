...
public class POS extends javax.swing.JFrame {
   ...
   private double subtotal = 0;
    ...
    String[] columns = {"Addon Name", "Price"};  // 🔥 NO ID COLUMN
    ...
    // 🔥 Formatting
    jTableAddons.getColumnModel().getColumn(0).setPreferredWidth(180); // Name wider
    jTableAddons.getColumnModel().getColumn(1).setPreferredWidth(80);  // Price
    ...
    String sql = "SELECT Name, Price FROM addons ORDER BY Name";  // 🔥 NO AddonID
    try (Connection con = ConnectorXampp.connect(); 
        ...
        while (rs.next()) {
            ...
            addonsModel.addRow(new Object[]{
                rs.getString("Name"),           // 🔥 Only Name
                String.format("₱%.2f", price)   // 🔥 Only Price
            });
        }
    } catch (Exception e) {
  ...
  private String getCurrentCashierName() {
    ...
    try {
        ...
        ps.setInt(3, userId);        // 🔥 NEW: Cashier ID
        ps.setDouble(4, cash);
        ...
        // 🔥 REST OF METHOD STAYS EXACTLY SAME
    ...
    // 🔥 Method 1: Check productIdMap keys that contain the displayName base
    ...
    // 🔥 Method 2: Fallback - extract base name and search DB
    try {
        String baseName = displayName.split("\\$")[0].trim(); // "Americano"
        try (Connection con = ConnectorXampp.connect();
             PreparedStatement ps = con.prepareStatement(
   ...
   private void resetPOS() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(458, 6, 1010, 470));
        ...
        jPanel1.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 590, 430, 200));
